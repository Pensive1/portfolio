...
export default function IcnPencilRuler({ size, fillColor }: svgIconProps) {
  return (
    <svg
      ...
      viewBox='0 0 24 24'
    >
      <title>pencil_ruler_line</title>
      <g
        id="pencil_ruler_line"
        fill='none'
        fillRule='evenodd'
      >
        <path
        ...
        <path
          fill={fillColor}
          d='m19.571 3.722.707.707a3 3 0 0 1 0 4.242l-2.975 2.975 3.182 3.182a2 2 0 0 1 0 2.829l-2.828 2.828a2 2 0 0 1-2.829 0l-3.182-3.182-2.363 2.364a1.5 1.5 0 0 1-.86.426l-3.92.53a1.001 1.001 0 0 1-1.126-1.127l.53-3.919a1.5 1.5 0 0 1 .426-.86l2.364-2.363-3.182-3.182a2 2 0 0 1 0-2.829l2.828-2.828a2 2 0 0 1 2.829 0l3.182 3.182 2.974-2.975a3 3 0 0 1 4.243 0m-3.682 9.339-2.828 2.828.353.354.707-.707a1 1 0 0 1 1.498 1.32l-.083.094-.707.707 1.414 1.414 2.828-2.828zm-1.268-5.804-8.755 8.755-.331 2.453 2.453-.332 8.755-8.754zM7.757 4.93 4.93 7.757l1.414 1.415.707-.707a1 1 0 0 1 1.498 1.32l-.084.094-.707.707.354.353 2.828-2.828zm8.986.207-.707.707 2.12 2.121.708-.707a1 1 0 0 0 0-1.414l-.707-.707a1 1 0 0 0-1.414 0'
        />
      </g>
    </svg>
  );
